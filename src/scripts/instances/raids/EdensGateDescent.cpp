...
class EdensGateDescent : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  EdensGateDescent() : Sapphire::ScriptAPI::InstanceContentScript( 30082 )
  { }
...
EXPOSE_SCRIPT( EdensGateDescent );