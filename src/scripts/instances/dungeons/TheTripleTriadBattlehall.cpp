...
class TheTripleTriadBattlehall : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheTripleTriadBattlehall() : Sapphire::ScriptAPI::InstanceContentScript( 2 )
  { }
...
EXPOSE_SCRIPT( TheTripleTriadBattlehall );