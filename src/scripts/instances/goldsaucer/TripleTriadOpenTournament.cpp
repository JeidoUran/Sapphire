...
class TripleTriadOpenTournament : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TripleTriadOpenTournament() : Sapphire::ScriptAPI::InstanceContentScript( 26001 )
  { }
...
EXPOSE_SCRIPT( TripleTriadOpenTournament );