...
class EdensGateInundationSavage : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  EdensGateInundationSavage() : Sapphire::ScriptAPI::InstanceContentScript( 30081 )
  { }
...
EXPOSE_SCRIPT( EdensGateInundationSavage );