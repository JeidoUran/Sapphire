...
class EdensGateResurrectionSavage : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  EdensGateResurrectionSavage() : Sapphire::ScriptAPI::InstanceContentScript( 30079 )
  { }
...
EXPOSE_SCRIPT( EdensGateResurrectionSavage );