...
class EdensGateSepulture : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  EdensGateSepulture() : Sapphire::ScriptAPI::InstanceContentScript( 30084 )
  { }
...
EXPOSE_SCRIPT( EdensGateSepulture );