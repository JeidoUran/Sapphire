...
public:
  ...
  void onInit( InstanceContent& instance ) override
  {
    ...
    instance.registerEObj( "unknown_18", 2007457, 7917581, 4, { -0.076355f, -848.020081f, -329.243896f }, 0.991760f, 0.000048f ); 
    ...
    //! RP Renamed eobjs
    instance.registerEObj( "cuve1", 2007457, 7879255, 4, { 60.562988f, 299.977112f, 281.239014f }, 0.991760f, 0.000048f ); 
    instance.registerEObj( "bigdoor", 2007457, 7877558, 4, { -162.279694f, 319.996796f, 1.693726f }, 0.991760f, 0.000048f ); 
    instance.registerEObj( "bump1", 2007457, 7875578, 4, { -123.004898f, 319.996887f, 17.571791f }, 0.991760f, 0.000048f ); 
    instance.registerEObj( "bump2", 2007457, 7880204, 4, { -98.056664f, 299.977997f, 100.305603f }, 0.991760f, 0.000048f ); 
    instance.registerEObj( "bump3", 2007457, 7880188, 4, { -70.572998f, 299.977112f, 161.303101f }, 0.991760f, 0.000048f ); 
    instance.registerEObj( "bump4", 2007457, 7880205, 4, { -15.618610f, 299.978210f, 228.156296f }, 0.991760f, 0.000048f ); 
    instance.registerEObj( "bump5", 2007457, 7880206, 4, { 89.311043f, 299.977112f, 316.640015f }, 0.991760f, 0.000048f ); 

    //! RP Altered eobjs
    instance.registerEObj( "Entrance", 2000182, 7917861, 5, { -142.754395f, 462.032715f, 0.010770f }, 0.991760f, 0.000144f ); 

    //! RP Added eobjs
    //instance.registerEObj( "portal", 2007181, 0, 4, { -145.718140f, 462.032715f, -14.316167f }, 1.000000f, -0.796802f ); 
    instance.registerEObj( "oculargate", 2002927, 0, 4, { -142.754395f, 463.032715f, 0.010770f }, 1.000000f, -0.016232f ); 
    instance.registerEObj( "notes", 2005180, 0, 4, { 98.682816f, 300.001343f, 298.843597f }, 1.000000f, 0.355421f ); 
  ...
  void onPlayerSetup( InstanceContent& instance, Entity::Player& player )
  {
    ...
    instance.getEObjByName( "cuve1" )->setAnimationFlag( 0, 4 );
    instance.getEObjByName( "bump1" )->setAnimationFlag( 0, 1 );
    instance.getEObjByName( "bump2" )->setAnimationFlag( 0, 1 );
    instance.getEObjByName( "bump3" )->setAnimationFlag( 0, 1 );
    instance.getEObjByName( "bump4" )->setAnimationFlag( 0, 1 );
    instance.getEObjByName( "bump5" )->setAnimationFlag( 0, 4 );
  }
