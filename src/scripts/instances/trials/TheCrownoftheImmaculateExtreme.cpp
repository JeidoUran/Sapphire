...
class TheCrownoftheImmaculateExtreme : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheCrownoftheImmaculateExtreme() : Sapphire::ScriptAPI::InstanceContentScript( 20065 )
  { }
...
EXPOSE_SCRIPT( TheCrownoftheImmaculateExtreme );